<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/FacultyMasterPage.master" AutoEventWireup="true" CodeFile="MasterEntry.aspx.cs" Inherits="Faculty_MasterEntry" %>
       ...
       <div class="col-sm-8">
           ...
           <br />
            <asp:GridView ID="GridView1" CssClass="table table-bordered table-sm table-hover" runat="server"
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblGVuser_name" CssClass=" form-control"  runat="server" Text='<%# Eval("Class")%>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtGVEdituser_name" CssClass=" form-control"  runat="server" Text='<%# Eval("Class")%>' ></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
       ...
       <div class="col-sm-8">
           ...
           <br />
            <asp:GridView ID="GridView2" CssClass="table table-bordered table-sm table-hover" runat="server"
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblGVuser_name" CssClass=" form-control"  runat="server" Text='<%# Eval("Department")%>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtGVEdituser_name" CssClass=" form-control"  runat="server" Text='<%# Eval("Department")%>' ></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
