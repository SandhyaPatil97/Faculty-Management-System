...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="card">
 <h5 class="card-title">Admin Profile Info</h5>
	...
	<table class="table">
		...
		<td>
			<asp:LinkButton ID="LinkButton1" CssClass="btn btn-outline-danger" 
				runat="server" onclick="LinkButton1_Click">Admin Personal Info</asp:LinkButton></td> 
		<td>
...
<div class="row">
    ...
    <div class="row" id="pnl5" runat="server">
       <div class="col-sm-12">
       <div style="width:100%; text-align:center; border-bottom:2px solid red"><h5> Admin Educational Details </h5></div> <br />
          <div class="row">
            <div class="col-md-12">
    ...
    <div style="width:100%; text-align:center; border-bottom:2px solid red"><h5>Add Admin Education Details </h5></div> <br />
       <div class="col-sm-3">
           <div class="form-group">
                <label>Class </label>
    ...
    <div style="width:100%; text-align:center; border-bottom:2px solid red"><h5>Add Admin Experience </h5></div>
    <br />
       <div class="col-sm-3">
           <div class="form-group">
