...
public partial class Admin_Workshop : System.Web.UI.Page
{
    ...
    private void BindGridview1()
    {
        try
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("select ID,NameOfFaculty,TitleOfWorkshop,OrganizedBy,WSDate ,NoOfDays,WSLevel,WSType from tblWorkshop ", con);//where CreatedBy=@CreatedBy
