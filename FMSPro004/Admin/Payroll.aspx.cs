...
public partial class Admin_Payroll : System.Web.UI.Page
{
    ...
    private void BindGridview()
    {
        ...
        SqlCommand cmd = new SqlCommand("select t1.ID,t1.MemberID,t1.MonthofPay,t2.Membername,t1.YearofPay,t1.Salary,t1.Deduction,t1.TotSalary,t1.PaymentDate,t1.SalSatatus from tblPayroll as t1 inner join tblMember as t2 on t1.MemberID=t2.ID  ", con);  //where t1.createdBy=@C
        cmd.CommandType = CommandType.Text;
