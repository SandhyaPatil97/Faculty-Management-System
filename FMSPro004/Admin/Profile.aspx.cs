...
public partial class Admin_Profile : System.Web.UI.Page
{
    ...
    protected void btnupdatepro_Click(object sender, EventArgs e)
    {
        if (txtAFullName.Text != string.Empty && txtAMobile.Text != string.Empty && txtAPosition.Text != string.Empty && txtADept.Text != string.Empty && txtAAddress.Text != string.Empty)
        {
            ...
            SqlCommand cmd = new SqlCommand("insert into tblProfile (FullName,Email,Mobile,Dept,Position,Addr,ImgName,ContentType,ProfileImage,CreatedBy,ProfileStatus) Values(@FullName,@Email,@Mobile,@Dept,@Position,@Addr,@ImgName,@ContentType,@ProfileImage,@CreatedBy,@ProfileStatus)",con);
            cmd.CommandType = CommandType.Text;
